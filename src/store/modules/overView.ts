...
export const useOverViewStore = defineStore({
    ...
    actions: {
        ...
        async _getBoxMessageData() {
            if (this.boxMessageData.length) return
        ...
        async _getInitMapsData() {
            if (this.overViewMapsData.length) return
